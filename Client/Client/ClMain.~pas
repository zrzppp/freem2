...
var
  ...
  LocalLanguage    :TImeMode = imChinese; //TImeMode = imSHanguel;   //LocalLanguage    :TImeMode = imChinese;
...
begin
   ...
   if datablock[1] = '+' then begin  //checkcode
      ...
      if tagstr = 'LNG'  then g_boCanLongHit := True;
      if tagstr = 'ULNG' then g_boCanLongHit := False;
      if tagstr = 'WID'  then g_boCanWideHit := True;
      if tagstr = 'UWID' then g_boCanWideHit := False;
   ...
   if g_MySelf = nil then begin
      case msg.Ident of
         ...
         SM_NEWCHR_FAIL: begin
           case msg.Recog of
             0: FrmDlg.DMessageDlg ('[Failure] This name has invalid characters or is not at least\4 characters long.', [mbOk]);
             2: FrmDlg.DMessageDlg ('[Failure] This name already exists or has been banned from being used.\Please contact a game master.', [mbOk]);
             3: FrmDlg.DMessageDlg ('[Failure] You already have 3 characters. To make another please\delete one of your current characters.', [mbOk]);
             4: FrmDlg.DMessageDlg ('[Failure] Character creating failure. Please ensure you have the lattest client and\if problem persists please contact a game master.', [mbOk]);
            else FrmDlg.DMessageDlg ('[Failure] Unknown error. Please Email: enterserver@emailhere.com', [mbOk]);
           end;
         end;
...
//        PlayScene.MemoLog.Lines.Add('X: ' + IntToStr(msg.Param) + 'Y: ' + IntToStr(msg.tag) + ' Map: ' + str);
      ...
      SM_WINEXP:
         begin
            ...
            if LongWord(MakeLong(msg.Param,msg.Tag)) = 1 then
              DScreen.AddChatBoardString ('1 experience point gained.',clWhite, clRed)
            else
      ...
      SM_LEVELUP:
         begin
            //08/08 - Damian:See other players level up.
            ...
            if Actor <> nil then begin
              ...
              if Actor = g_MySelf then begin
                ...
                DScreen.AddChatBoardString ('Congratulations! You have leveled up.',clWhite, clPurple);
              end;
            end;
         end;
      ...
      SM_GTTRADE:
        begin
          if mrOk = FrmDlg.DMessageDlg ('Would you like to buy this guild territory for ' +
            IntToStr(msg.Recog) + 'Gold?', [mbOk, mbCancel])
          then begin
            self.SendTradeGT(1);
          end else
            self.SendTradeGT(0);
...
//            if WaitingUseItem.Index in [0..8] then
      ...
      SM_GOLDCHANGED:
         begin
            ...
            if msg.Recog > g_MySelf.m_nGold then begin
               DScreen.AddSysMsg (GetGoldStr(msg.Recog-g_MySelf.m_nGold) + ' ' + g_sGoldName + ' gained.');
            end;
            g_MySelf.m_nGold := msg.Recog;
      ...
      SM_CONSIGN_OK:
        begin
          FrmDlg.LastestClickTime := GetTickCount;
          Dscreen.AddChatBoardString('Your item has been consigned.',clwhite,clgreen);
          g_SellDlgItemSellWait.S.Name := '';
      ...
      SM_CONSIGN_FAIL:
         begin
            FrmDlg.LastestClickTime := GetTickCount;
            case msg.Recog of
               1: FrmDlg.DMessageDlg ('Minimum price for selling an item is 1000 gold.', [mbOk]);
               2: FrmDlg.DMessageDlg ('Maximum price for selling an item is 50 000 000 gold.', [mbOk]);
               3: FrmDlg.DMessageDlg ('Merchant not found.', [mbOk]);
               4: FrmDlg.DMessageDlg ('Item not found.', [mbOk]);
               5: FrmDlg.DMessageDlg ('You need 1000 gold to consign an item.', [mbOk]);
            end;
      ...
      SM_MAKEDRUG_FAIL: begin
        FrmDlg.LastestClickTime := GetTickCount;
        case msg.Recog of
          1: FrmDlg.DMessageDlg ('Item does not exist.', [mbOk]);
          2: FrmDlg.DMessageDlg ('Bag is full.', [mbOk]);
          3: FrmDlg.DMessageDlg (g_sGoldName{'½ð±Ò'} + 'required.', [mbOk]);
          4: FrmDlg.DMessageDlg ('Missing one of the items required.', [mbOk]);
        end;
      end;
      SM_716: begin
      ...
      SM_GROUPDELMEM_FAIL:
         begin
            g_dwChangeGroupModeTick := GetTickCount;
            case msg.Recog of
               -1: FrmDlg.DMessageDlg ('You are not the group leader.', [mbOk]);
               -2: FrmDlg.DMessageDlg ('Player not found.', [mbOk]);
               -3: FrmDlg.DMessageDlg ('Player not in this group.', [mbOk]);
            end;
         end;
      ...
      SM_OPENGUILDDLG_FAIL:
         begin
            g_dwQueryMsgTick := GetTickCount;
            FrmDlg.DMessageDlg ('You are not presently in a guild.', [mbOk]);
         end;
      ...
      SM_GUILDDELMEMBER_FAIL: begin
        case msg.Recog of
          1: FrmDlg.DMessageDlg('You are not guild leader.', [mbOk]);
          2: FrmDlg.DMessageDlg('This person is not a member of this guild', [mbOk]);
          3: FrmDlg.DMessageDlg('You cannot remove yourself from an active guild', [mbOk]);
          4: FrmDlg.DMessageDlg('This person is not a member of this guild', [mbOk]);
        end;
      end;
      SM_GUILDRANKUPDATE_FAIL: begin
        case msg.Recog of
          -2: FrmDlg.DMessageDlg('[Fail] You cannot remove rank 1', [mbOk]);
          -3: FrmDlg.DMessageDlg('[Fail] You cannot remove all guild leaders', [mbOk]);
          -4: FrmDlg.DMessageDlg('[Fail] Can only have 2 guild leaders', [mbOk]);
          -5: FrmDlg.DMessageDlg('[Fail] Cannot add or delete members this way', [mbOk]);
          -6: FrmDlg.DMessageDlg('[Fail] You did not change anything to the rank list', [mbOk]);
          -7: FrmDlg.DMessageDlg('[Fail] You can only have ranks between 0 and 99', [mbOk]);
        end;
      end;
      SM_GUILDMAKEALLY_OK,
      SM_GUILDMAKEALLY_FAIL: begin
        case msg.Recog of
          -1: FrmDlg.DMessageDlg ('You need to face another player', [mbOk]);
          -2: FrmDlg.DMessageDlg ('You are at war with this guild', [mbOk]);
          -3: FrmDlg.DMessageDlg ('You need to face the guild leader', [mbOk]);
          -4: FrmDlg.DMessageDlg ('Other person did not enable alliance', [mbOk]);
        end;
      end;
      ...
      SM_GUILDBREAKALLY_FAIL: begin
        case msg.Recog of
          -1: FrmDlg.DMessageDlg ('You are not guild leader', [mbOk]);
          -2: FrmDlg.DMessageDlg ('You are not allied with this guild', [mbOk]);
          -3: FrmDlg.DMessageDlg ('Guild does not exist', [mbOk]);
        end;
      end;
      ...
      SM_BUILDGUILD_FAIL: begin
        FrmDlg.LastestClickTime := GetTickCount;
        case msg.Recog of
          -1: FrmDlg.DMessageDlg('You are already in a guild', [mbOk]);
          -2: FrmDlg.DMessageDlg('Insufficient gold', [mbOk]);
          -3: FrmDlg.DMessageDlg('You need a Woomahorn to create a guild', [mbOk]);
          else FrmDlg.DMessageDlg('Guildnames have to be between 1 and 16 chars', [mbOk]);
        end;
      end;
      SM_MENU_OK: begin
        FrmDlg.LastestClickTime:=GetTickCount;
      ...
      SM_REQUESTRELAY: begin
        if mrOk = FrmDlg.DMessageDlg (body + ' has invited you into a relationship.\' +
                                           'Once the raltionship is established, breaking the relationship\' +
                                           'will result in payment of 100,000 Gold in compensation for the breach.\' +
                                           'Will you engage in the relationship?', [mbOk, mbCancel]) then begin
      ...
      SM_REQUESTRELAYFAIL: begin
        FrmDlg.DMessageDlg(body + ' has denied your request to start a relationship!',[mbOK]);
      end;
...
//  end;
               ...
               if g_wAvailIDDay > 0 then begin
                  if g_wAvailIDDay = 1 then
                     FrmDlg.DMessageDlg ('You are connected through personal account.', [mbOk])
                  else if g_wAvailIDDay <= 3 then
                     FrmDlg.DMessageDlg ('Your account is valid for:  ' + IntToStr(g_wAvailIDDay) + ' days', [mbOk]);
               end else if g_wAvailIPDay > 0 then begin
                  if g_wAvailIPDay = 1 then
                     FrmDlg.DMessageDlg ('You are connected through fixed amount IP.', [mbOk])
...
begin
  ...
  if ((g_nMapIndex < 0) and g_boViewMap) then
    Dscreen.AddChatBoardString('No big map availiable.', clWhite, clRed);
      ...
      for I := 0 to FrmDlg.FriendList[A].Count-1 do begin
        ...
        if Friend <> nil then begin
          if Lowercase(Friend.Name) = LowerCase(Body) then begin
            ...
            if (status = 1) and (Not Friend.Blacklist) then DScreen.AddChatBoardString('=> Friend '+Friend.Name+' has come online!',clBlack, clLime)
            else if (Not Friend.Blacklist) then DScreen.AddChatBoardString('=> Friend '+Friend.Name+' has gone offline!',clWhite, clRed);
          end;
        end;
      end;
    end;
...
begin
  if body <> '' then begin
    ...
    FrmDlg.DMessageDlg('Adding friend '''+sFriendName+''' Failed.\Reason: '+sReason,[mbOK]);
  end;
end;
...
begin
  ...
  case nType of
    ...
    14: begin // yimoogi doing magic attack
  ...
  if CompareText(sCmd1,'@svninfo') = 0 then begin
    if CompareText(sCmd,'client') = 0 then begin
      ...
      if (SVN_ISTracking) and (SVN_DETAILS.Count > 0) then begin
        DScreen.AddChatBoardString ('SVN Information:', clRed, clWhite);
        for I := 0 to SVN_DETAILS.Count-1 do DScreen.AddChatBoardString (' ['+inttostr(I+1)+'] '+SVN_DETAILS.Strings[I], clRed, clWhite);
        DScreen.AddChatBoardString ('SVN Revision: '+inttostr(SVN_REVISION), clWhite, clGreen);
      end
      else begin
        DScreen.AddChatBoardString ('No SVN Revision Data Available', clWhite, clRed);
      end;
      DScreen.AddChatBoardString ('Build Time: '+FormatDateTime('dd mmm yyyy/hh:nn:ss',UnixToDateTime(BUILDTIME))+' ('+inttostr(BUILDTIME)+')', clWhite, clGreen);
    end
    else if CompareText(sCmd,'server') = 0 then begin
      DScreen.AddChatBoardString ('Asking server for information..', clRed, clWhite);    
      SendClientMessage(CM_SAY, 0, 0, 0, 0,'@svninfo '+sCmd);
    end
    else begin
      DScreen.AddChatBoardString ('!! Please specify a part. (client/server) (Example: @svninfo client)', clWhite, clRed);
    end;
  end
...
begin
  if Msg.Recog = 0 then begin
    // Clear the mail list in preperation for all items being resent.
    while frmDlg.MailList.Count > 0 do dispose(frmDlg.MailList.Items[0]);    
    frmDlg.MailList.Clear;
  end
  else if Msg.Recog = 1 then begin
    // Maillist recieved, request blocklist
...
//  DScreen.AddSysMsg ('Time: '+inttostr(Item.Time));
  ...
  if Msg.Recog = 1 then DScreen.AddChatBoardString('[*] You have mail!',clWhite,clRed);
...
begin
  Body := DecodeString(Body);
  frmDlg.DMessageDlg('Mail sent to '+body+'.',[mbok]);
end;
...
begin
  Body := DecodeString(Body);
  Parts := Split(#1,Body);
  frmDlg.DMessageDlg('Failed to send mail to '+Parts.Strings[0]+'.\Reason:'+Parts.Strings[1],[mbok]);
end;
...
begin
  ...
  Item.Name := Body;
  frmDlg.BlockList.Add(Item);
  frmDlg.DMessageDlg(body+' has been added to the blocklist.',[mbok]);
end;
...
begin
  Body := DecodeString(Body);
  Parts := Split(#1,Body);
  frmDlg.DMessageDlg('Failed to add '+Parts.Strings[0]+' to blocklist.\Reason:'+Parts.Strings[1],[mbok]);
end;

procedure TFrmMain.ClientBlockListDeleted(msg: TDefaultMessage; body: string);
begin
  Body := DecodeString(Body);
  frmDlg.DMessageDlg(body+' has been deleted from the blocklist.',[mbok]);
end;
...
begin
  if AutoRunTimer.Enabled Then begin
    AutoRunTimer.Enabled:=False;
    DScreen.AddChatBoardString ('<Auto run off>', clGreen, clWhite);
  end else begin
    AutoRunTimer.Enabled:=True;
    DScreen.AddChatBoardString ('<Auto run on>', clGreen, clWhite);
  end;
end;
