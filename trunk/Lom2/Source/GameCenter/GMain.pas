...
begin
  ...
  if Application.MessageBox('是否确认关闭翎风游戏控制器 ?','确认信息',MB_YESNO + MB_ICONQUESTION) = mrYes then begin
    CanClose:=True;
  end else begin
    CanClose:=False;
  end;
...
begin
  EditGameDir.Text:='D:\GameOfMir\';
  EditHeroDB.Text:='HeroDB';
  EditGameName.Text:='翎风世界';
