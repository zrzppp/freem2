...
begin
  ERowCount.Value := 8;
  AddrGrid.Cells[0, 0] := '½ÇÉ«Ñ¡ÔñÍø¹ØµØÖ·';
  AddrGrid.Cells[1, 0] := 'ÓÎÏ·Íø¹Ø';
  AddrGrid.Cells[2, 0] := '¶Ë¿Ú';
  AddrGrid.Cells[3, 0] := 'ÓÎÏ·Íø¹Ø';
  AddrGrid.Cells[4, 0] := '¶Ë¿Ú';
  AddrGrid.Cells[5, 0] := 'ÓÎÏ·Íø¹Ø';
  AddrGrid.Cells[6, 0] := '¶Ë¿Ú';
  AddrGrid.Cells[7, 0] := 'ÓÎÏ·Íø¹Ø';
...
begin
  ...
  try
    ...
    ShowMessage(sGateConfFileName + ' ±£´æÒì³££¡£¡£¡');
  end;
  Self.Close;
end;
...
begin
  ...
  try
    ...
    ShowMessage(sGateConfFileName + ' ¶ÁÈ¡Òì³££¡£¡£¡');
  end;
  n1C := 1;
