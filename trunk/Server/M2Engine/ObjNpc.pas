...
type
  ...
  private
    ...
    function ConditionOfGetValValue(PlayObject: TPlayObject; sMsg: string; var sValue: string): Boolean; overload;
    function ConditionOfGetValValue(PlayObject: TPlayObject; sMsg: string; var nValue: Integer): Boolean; overload;
...
procedure TMerchant.UserSelect(PlayObject: TPlayObject; sData: string);
  ...
  procedure SellSellItem(User: TPlayObject); //004A1544
  begin
...
begin
  ...
  if (nCreditPoint < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nCreditPoint)) then begin
...
begin
  ...
  if (nExp < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nExp)) then begin
...
begin
  ...
  if (nLevel < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nLevel)) then begin
...
begin
  ...
  if (nPKPOINT < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nPKPOINT)) then begin
...
begin
  ...
  if (nGameGold < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nGameGold)) then begin
...
begin
  ...
  if (nGamePoint < 0) and (not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nGamePoint)) then begin
...
begin
  ...
  ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, sParam2);
...
begin
  ...
  ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, sParam1);
...
begin
  ...
  if sRankLevelName = '' then begin
    ...
    if (UpCase(sRankLevelName[1]) <> '%') and (UpCase(sRankLevelName[2]) <> 's') then begin
...
begin
  ...
  if nGold < 0 then
    ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nGold);
...
begin
  //MainOutMessage('ActionOfNotLineAddPiont: QuestActionInfo.sParam1:'+QuestActionInfo.sParam1+' QuestActionInfo.sParam2: '+QuestActionInfo.sParam2);
...
begin
  Result := False;
  if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, nSize) then begin //增加变量支持
...
begin
  ...
  if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nCount) then begin //增加变量支持
...
begin
  ...
  if nMIN < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nMIN); //增加变量支持
  end;
  if nMax < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam4, nMax); //增加变量支持
  end;
...
begin
  ...
  if dwExp = 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nExp) then begin //增加变量支持
...
begin
  ...
  if nPoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nPoint) then begin //增加变量支持
...
begin
  ...
  if nGameGold < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nGameGold) then begin //增加变量支持
...
begin
  ...
  if nGamePoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nGamePoint) then begin //增加变量支持
...
begin
  ...
  if nX < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nX); //增加变量支持
  end;
  if nY < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nY); //增加变量支持
  end;
  if nRange < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam4, nRange); //增加变量支持
  end;
...
begin
  ...
  if nDay < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nDay); //增加变量支持
  end;
...
begin
  ...
  if nWhere < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, nWhere); //增加变量支持
  end;
  cMethod := QuestConditionInfo.sParam2[1];
  nAddValue := Str_ToInt(QuestConditionInfo.sParam3, -1);
  if nAddValue < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nAddValue); //增加变量支持
  end;
...
begin
  ...
  if nType < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nType); //增加变量支持
  end;
...
begin
  ...
  if nLevel < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nLevel) then begin //增加变量支持
...
begin
  ...
  nType := Str_ToInt(QuestConditionInfo.sParam2, -1);
  if nType < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nType) then begin //增加变量支持
...
begin
  ...
  nLevel := Str_ToInt(QuestConditionInfo.sParam2, -1);
  if nLevel < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nLevel) then begin //增加支持变量
...
begin
  ...
  nCount := Str_ToInt(QuestConditionInfo.sParam2, -1);
  if nCount < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nCount) then begin
...
begin
  ...
  if nSkillLevel < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nSkillLevel) then begin
...
begin
  ...
  ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, sValue1);
  ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, sValue2);
...
function TNormNpc.ConditionOfGetValValue(PlayObject: TPlayObject;
...
begin
  ...
  ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, sValue2);
  ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam3, sValue3);
...
var
  ...
  begin
    ...
    for i := 0 to ConditionList.Count - 1 do begin
      ...
      case QuestConditionInfo.nCMDCode of
        ...
        nCHECKGOLD: begin
            if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, n14) then begin //增加变量支持
        ...
        nCHECKHUM: begin //0049C4CB
            if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, n14) then begin //增加变量支持
        ...
        nCHECKBAGGAGE: begin
            if PlayObject.IsEnoughBag then begin
              if QuestConditionInfo.sParam1 <> '' then begin
                Result := False;
                if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, s01) then begin //增加变量支持
        ...
        nSC_CHECKTEXTLIST: begin
            s01 := QuestConditionInfo.sParam1;
            ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, s01);
        ...
        nSC_ISDUPMODE: begin
            if PlayObject.m_PEnvir <> nil then begin
              if PlayObject.m_PEnvir.GetXYObjCount(PlayObject.m_nCurrX, PlayObject.m_nCurrY) >= 2 then Result := False;
            end else Result := False;
          end;
        else begin
  ...
  procedure TakeItem(sItemName: string; nItemCount: Integer; sVarNo: string); //0049C998
  var
    i: Integer;
    UserItem: pTUserItem;
    StdItem: pTStdItem;
  ...
  begin
    nCount := nItemCount;
    sName := sItemName;
    ConditionOfGetValValue(PlayObject, sItemName, sName); //增加变量支持
    ConditionOfGetValValue(PlayObject, sVarNo, nCount); //增加变量支持
  ...
  begin
    ...
    for i := 0 to ActionList.Count - 1 do begin
      ...
      case QuestActionInfo.nCMDCode of
        ...
        nTAKEW: begin
            if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, s4C) then begin //增加变量支持
              s4C := QuestActionInfo.sParam1;
            end;
            if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, n14) then begin //增加变量支持
        ...
        nMAPMOVE: begin
            ...
            if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam3, n40) then begin //增加变量支持
        ...
        nPKPOINT: begin
            if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, n14) then begin //增加变量支持
        ...
        nSC_ADDTEXTLIST: begin
            s4C := QuestActionInfo.sParam1;
            ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, s4C);
        ...
        nSC_INTTOSTR: begin
            n40 := 0;
            ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, n40);
            n14 := GetValNameNo(QuestActionInfo.sParam1);
            if n14 >= 0 then begin
              case n14 of
                600..699: begin
...
var
  nColor: Integer;
begin
  if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nColor) then begin //增加变量支持
...
begin
  ...
  if nReLevel < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nReLevel); //增加变量支持
  end;
  if nLevel < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nLevel); //增加变量支持
  end;
  if nBounsuPoint < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam3, nBounsuPoint); //增加变量支持
  end;
...
var
  ...
  nItemCount: Integer;
begin
  if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, sItemName) then begin //增加变量支持
    sItemName := QuestActionInfo.sParam1;
  end;
  if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nItemCount) then begin //增加变量支持
...
begin
  ...
  if nAuraePoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nAuraePoint) then begin //增加变量支持
...
begin
  ...
  if nBuildPoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nBuildPoint) then begin //增加变量支持
...
begin
  ...
  if nFlourishPoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nFlourishPoint) then begin //增加变量支持
...
begin
  ...
  if nStabilityPoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nStabilityPoint) then begin //增加变量支持
...
begin
  ...
  if nHP < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nHP) then begin //增加变量支持
...
begin
  ...
  if nMP < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nMP) then begin //增加变量支持
...
begin
  ...
  if nBonusPoint < 0 then begin
    ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nBonusPoint); //增加变量支持
  end;
...
begin
  nLevel := Str_ToInt(QuestActionInfo.sParam2, -1);
  if nLevel < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nLevel) then begin //增加变量支持
...
begin
  nType := Str_ToInt(QuestActionInfo.sParam2, -1);
  if nType < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nType) then begin //增加变量支持
...
begin
  ...
  sMapName := QuestConditionInfo.sParam1;
  nCount := Str_ToInt(QuestConditionInfo.sParam2, -1);
  if nCount < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nCount);
  Envir := g_MapManager.FindMap(sMapName);
...
begin
  ...
  if nX < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nX);
  if nY < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nY);
  if nRange < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam4, nRange);
  if nCount < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam6, nCount);
  Envir := g_MapManager.FindMap(sMapName);
...
begin
  Result := False;
  nWhere := Str_ToInt(QuestConditionInfo.sParam1, -1);
  if nWhere < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, nWhere);
...
begin
  ...
  if nGold < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nGold);
  if (nGold < 0) or (m_Castle = nil) then begin
...
begin
  ...
  if nContribution < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nContribution) then begin //增加变量支持
...
begin
  ...
  if nCreditPoint < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nCreditPoint) then begin //增加变量支持
...
begin
  ...
  if (nNeed < 0) then begin
    if not ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nNeed) then begin //增加变量支持
...
begin
  ...
  if (PlayObject.m_MyGuild <> nil) then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, sGuildName) then begin //增加变量支持
...
begin
  ...
  if nOnlineMin < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nOnlineMin) then begin //增加变量支持
...
begin
  ...
  if nErrorCount < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam2, nErrorCount) then begin //增加变量支持
...
begin
  ...
  if nPayMent < 1 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, nPayMent) then begin //增加变量支持
...
begin
  ...
  if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, sSlaveName) then begin //增加变量支持
...
begin
  ...
  if nWhere < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nWhere); //增加变量支持
  if nRate < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nRate); //增加变量支持
  if nPoint < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam3, nPoint); //增加变量支持
...
begin
  ...
  nPoint := Str_ToInt(QuestActionInfo.sParam4, -1);
  if nWhere < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam1, nWhere); //增加变量支持
  if nValType < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam2, nValType); //增加变量支持
  if nRate < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam3, nRate); //增加变量支持
  if nPoint < 0 then ConditionOfGetValValue(PlayObject, QuestActionInfo.sParam4, nPoint); //增加变量支持
...
begin
  ...
  if nCount < 0 then begin
    if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nCount) then begin //增加变量支持
      ScriptConditionError(PlayObject, QuestConditionInfo, sSC_CHECKMAPHUMANCOUNT);
      Exit;
    end;
  end;
  if not ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam1, sMapName) then begin //增加变量支持
    sMapName := QuestConditionInfo.sParam1;
  end;
...
begin
  ...
  if nCount < 0 then ConditionOfGetValValue(PlayObject, QuestConditionInfo.sParam3, nCount);
