...
begin
  ...
  HumanGrid.Cells[6, 5]  := 'Exp';
  HumanGrid.Cells[7, 5]  := 'MaxExp';
  HumanGrid.Cells[8, 5]  := 'PK-Point';
  HumanGrid.Cells[9, 5]  := '';
  HumanGrid.Cells[10, 5] := 'ID';
  HumanGrid.Cells[11, 5] := 'Latest';

  HumanGrid.Cells[0, 7]  := 'Dear';
  HumanGrid.Cells[1, 7]  := 'Master';
  HumanGrid.Cells[2, 7]  := 'StoragePwd';
  HumanGrid.Cells[3, 7]  := 'Credits';
  HumanGrid.Cells[4, 7]  := '';
  HumanGrid.Cells[5, 7]  := '';
  HumanGrid.Cells[6, 7]  := '';
  HumanGrid.Cells[7, 7]  := '';
