...
var
  ...
  g_sProgram:string= 'OByiH^=HWrYeWaIaXcUaX^=OPPnlu_@jH<';
  ...
  g_sSQLString :String;
//  g_sSQLString :String = 'Provider=SQLOLEDB.1;Password='+g_Config.g_sSQLPassword+';Persist Security Info=True;User ID='+g_Config.g_sSQLUserName+';Initial Catalog='+g_Config.g_sSQLDatabase+';Data Source='+g_Config.g_sSQLHost';
...
procedure LoadDBSetup;
begin
    g_sSQLString := 'Provider=SQLOLEDB.1;Password='+g_Config.g_sSQLPassword+';Persist Security Info=True;User ID='+g_Config.g_sSQLUserName+';Initial Catalog='+g_Config.g_sSQLDatabase+';Data Source='+g_Config.g_sSQLHost;
end;
